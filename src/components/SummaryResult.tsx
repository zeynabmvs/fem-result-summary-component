...
const SummaryResult = () => {
  return (
    <section className="grid grid-rows-2 md:grid-cols-2 md:grid-rows-1 w-full md:w-[736px] md:h-[524px] bg-white md:shadow-[0_19px_50px_14px_rgba(0,0,0,0.25)] md:shadow-n-pale-blue md:rounded-[30px] md:my-8">
      <div
        id="result"
